...
<div className="w-full h-screen z-40 pt-20 lg:pt-40 bg-gray-300">
		<div className="z-50 w-full lg:w-3/5 lg:h-[550px] bg-white lg:absolute lg:top-52 drop-shadow-2xl left-0  lg:left-20 lg:rounded-xl overflow-hidden">
				<div className="px-2 lg:px-0 w-full h-[470px] lg:h-full bg-gray-100 py-2 flex flex-col gap-[2px] overflow-auto">
		...
		<div className="z-40 w-full lg:w-2/5 h-fit bottom-0 md:h-[350px] lg:h-[550px] bg-white absolute lg:top-52 drop-shadow-xl right-0 flex flex-row justify-end  lg:right-20 lg:rounded-xl overflow-hidden">
